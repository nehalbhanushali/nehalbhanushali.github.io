	  ...
	  function Gallery(props) {
	    ...
	    _this.state = { key: '',
	      ...
	      data: [{
	        ...
	        ti: "Bravos",
	        hashTag: "#GOT",
	        comments: [{ commentbyname: "Jon Snow", commentbyavatar: "http://jamidavisphotography.com/wp-content/uploads/2016/02/St.-Petersburg-Photography-2.jpg", comment: "A girl is Arya Stark of Winterfell" }, { commentbyname: "Nameless girl", commentbyavatar: "http://jamidavisphotography.com/wp-content/uploads/2016/02/St.-Petersburg-Photography-2.jpg", comment: "You wer never a fit !" }]
	      }, {
	  ...
	  _createClass(Gallery, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        searchToggle ? { filteredPosts: filteredPosts } : { allPosts: allPosts },
	        '     '
	      );
	    }
	  }]);
...
//# sourceMappingURL=0.4b78d10975d77baadd94.hot-update.js.map