	...
	var LikeButton = function (_React$Component) {
	  ...
	  _createClass(LikeButton, [{
	    ...
	    value: function render() {
	      ...
	      var fillIcon = _react2.default.createElement(
	        FontIcon,
	        { className: 'material-icons', color: '#f00' },
	        'palette'
	      );
	      return _react2.default.createElement(
	        _IconButton2.default,
	        { onClick: this.handleClick },
	        this.state.liked ? _react2.default.createElement(_favorite2.default, { color: '#f00' }) : { fillIcon: fillIcon }
	      );
	    }
	  }]);
...
//# sourceMappingURL=0.c18bd857f98605bc2248.hot-update.js.map