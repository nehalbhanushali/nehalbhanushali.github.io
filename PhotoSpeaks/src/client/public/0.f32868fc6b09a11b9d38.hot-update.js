	...
	var Page = function (_React$Component) {
	  ...
	  _createClass(Page, [{
	    ...
	    value: function handlePost(url, tag) {
	      ...
	      console.log(" url pop>>  " + url + " tag>> " + tag + " name>> " + _data2.default.props.username);
	      /*Gallery.data.push({
	       im:{url},
	       postbyname:'hjk',
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_data2.default, { username: this.state.username, data: this.handlepost })
	      );
	    }
	  }]);
...
//# sourceMappingURL=0.f32868fc6b09a11b9d38.hot-update.js.map