	  ...
	  _createClass(AwesomeComponent, [{
	    ...
	    value: function render() {
	      ...
	      var commentList = this.props.comments.map(function (comment) {
	        ...
	        _react2.default.createElement(_CommentBox2.default, { key: comment.id, commentbyname: comment.commentbyname,
	          commentbyavatar: comment.commentbyavatar, comment: comment.comment });
	      });
	
	      return _react2.default.createElement(
	        _reactBootstrap.Col,
	        _defineProperty({ xs: 12, md: 8, lgOffset: 3, lg: 6 }, 'lgOffset', 3),
...
//# sourceMappingURL=0.ac138db78978dbfc1f1a.hot-update.js.map