...
/***/ function(module, exports, __webpack_require__) {
	...
	var Gallery = function (_React$Component) {
	  ...
	  function Gallery(props) {
	    ...
	    _this.handlePostData = _this.handlePostData.bind(_this);
	    return _this;
	  }
	
	  _createClass(Gallery, [{
	    key: 'handlePostData',
	    value: function handlePostData(url, tag, name) {
	      var url = this.props.postURL;
	      var tag = this.props.postTag;
	      var username = this.props.username;
	
	      console.log(" url>>  " + url + " tag hh >> " + tag + " name>> " + username);
	    }
	  }, {
	    key: 'handleTagSearch',
...
//# sourceMappingURL=0.f1d3ef66310538302330.hot-update.js.map