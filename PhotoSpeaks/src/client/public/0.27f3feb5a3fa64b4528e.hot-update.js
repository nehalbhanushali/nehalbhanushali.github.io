	  ...
	  _createClass(Page, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_data2.default, { username: this.state.username, post: this.handlePost, postURL: this.state.url, postTag: this.state.tag })
	      );
	    }
	  }]);
...
//# sourceMappingURL=0.27f3feb5a3fa64b4528e.hot-update.js.map