	...
	var Gallery = function (_React$Component) {
	  ...
	  _createClass(Gallery, [{
	    ...
	    value: function handleData() {
	      console.log(" handleData in data ");
	    ...
	    value: function render() {
	      ...
	      var filteredPosts = filteredPostData.map(function (pics) {
	        return _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement(_AwesomeComponent2.default, { tagForSearch: searchFunction, data: this.handleData, userLoggegIn: username, pic: pics.im, postbyname: pics.postbyname, postbyavatar: pics.postbyavatar, title: pics.ti, notes: pics.hashTag, comments: pics.comments })
	        );
	      });
...
//# sourceMappingURL=0.de139d5c53154d725cf7.hot-update.js.map