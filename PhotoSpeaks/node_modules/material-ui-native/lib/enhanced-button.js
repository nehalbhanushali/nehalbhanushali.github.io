...
var EnhancedButton = _reactNative2['default'].createClass({
  ...
  propTypes: {
    centerRipple: _reactNative2['default'].PropTypes.bool,
    containerElement: _reactNative2['default'].PropTypes.oneOfType([_reactNative2['default'].PropTypes.string, _reactNative2['default'].PropTypes.element]),
    disabled: _reactNative2['default'].PropTypes.bool,
    disableFocusRipple: _reactNative2['default'].PropTypes.bool,
    disableKeyboardFocus: _reactNative2['default'].PropTypes.bool,
    disableTouchRipple: _reactNative2['default'].PropTypes.bool,
    keyboardFocused: _reactNative2['default'].PropTypes.bool,
    linkButton: _reactNative2['default'].PropTypes.bool,
    focusRippleColor: _reactNative2['default'].PropTypes.string,
    touchRippleColor: _reactNative2['default'].PropTypes.string,
    focusRippleOpacity: _reactNative2['default'].PropTypes.number,
    touchRippleOpacity: _reactNative2['default'].PropTypes.number,
    onBlur: _reactNative2['default'].PropTypes.func,
    onFocus: _reactNative2['default'].PropTypes.func,
    onKeyboardFocus: _reactNative2['default'].PropTypes.func,
    onKeyDown: _reactNative2['default'].PropTypes.func,
    onKeyUp: _reactNative2['default'].PropTypes.func,
    onTouchTap: _reactNative2['default'].PropTypes.func,
    tabIndex: _reactNative2['default'].PropTypes.number,
    style: _reactNative2['default'].PropTypes.object
  },

  getDefaultProps: function getDefaultProps() {
    return {
      containerElement: _reactNative2['default'].createElement(View),
  ...
  render: function render() {
    ...
    return _reactNative2['default'].isValidElement(containerElement) ? _reactNative2['default'].cloneElement(containerElement, buttonProps, buttonChildren) : _reactNative2['default'].createElement(linkButton ? 'a' : containerElement, buttonProps, buttonChildren);
  },
  ...
  _createButtonChildren: function _createButtonChildren() {
    ...
    //Focus Ripple
    var focusRipple = isKeyboardFocused && !disabled && !disableFocusRipple && !disableKeyboardFocus ? _reactNative2['default'].createElement(_ripplesFocusRipple2['default'], {
    ...
    //Touch Ripple
    var touchRipple = !disabled && !disableTouchRipple ? _reactNative2['default'].createElement(
