...
var FlatButton = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    hoverColor: _reactNative2['default'].PropTypes.string,
    label: validateLabel,
  ...
  render: function render() {
    ...
    var
    //buttonMinWidth,
    disabledTextColor = _constructor$getRelevantContextKeys.disabledTextColor;
    ...
    var labelElement = label ? _reactNative2['default'].createElement(_buttonsFlatButtonLabel2['default'], { label: label, style: labelStyle }) : undefined;
