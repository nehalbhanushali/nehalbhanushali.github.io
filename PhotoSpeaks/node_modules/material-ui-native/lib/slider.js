...
var minMaxPropType = function minMaxPropType(props, propName, componentName) {
  var error = _reactNative2['default'].PropTypes.number(props, propName, componentName);
...
var Slider = _reactNative2['default'].createClass({
  displayName: 'Slider',
  ...
  propTypes: {
    name: _reactNative2['default'].PropTypes.string.isRequired,
    defaultValue: valueInRangePropType,
    description: _reactNative2['default'].PropTypes.string,
    disabled: _reactNative2['default'].PropTypes.bool,
    error: _reactNative2['default'].PropTypes.string,
    max: minMaxPropType,
    min: minMaxPropType,
    ...
    onDragStart: _reactNative2['default'].PropTypes.func,
    onDragStop: _reactNative2['default'].PropTypes.func,
  ...
  render: function render() {
    ...
    if (!this.props.disabled && !this.props.disableFocusRipple) {
      focusRipple = _reactNative2['default'].createElement(_ripplesFocusRipple2['default'], {
        ref: 'focusRipple',
        key: 'focusRipple',
        style: rippleStyle,
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(View, { className: 'mui-input-highlight' }),
      _reactNative2['default'].createElement(View, { className: 'mui-input-bar' }),
      ...
      _reactNative2['default'].createElement(
        ...
        _reactNative2['default'].createElement(
          ...
          _reactNative2['default'].createElement(View, { style: this.prepareStyles(styles.filled) }),
          _reactNative2['default'].createElement(View, { style: this.prepareStyles(remainingStyles) }),
          _reactNative2['default'].createElement(
            View,
      ...
      _reactNative2['default'].createElement(TextInput, { ref: 'input', type: 'hidden',
