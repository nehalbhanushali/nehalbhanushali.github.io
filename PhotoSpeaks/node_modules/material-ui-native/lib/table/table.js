...
var Table = _reactNative2['default'].createClass({
  displayName: 'Table',
  ...
  propTypes: {
    allRowsSelected: _reactNative2['default'].PropTypes.bool,
    fixedFooter: _reactNative2['default'].PropTypes.bool,
    fixedHeader: _reactNative2['default'].PropTypes.bool,
    height: _reactNative2['default'].PropTypes.string,
    multiSelectable: _reactNative2['default'].PropTypes.bool,
    onCellClick: _reactNative2['default'].PropTypes.func,
    onCellHover: _reactNative2['default'].PropTypes.func,
    onCellHoverExit: _reactNative2['default'].PropTypes.func,
    onRowHover: _reactNative2['default'].PropTypes.func,
    onRowHoverExit: _reactNative2['default'].PropTypes.func,
    onRowSelection: _reactNative2['default'].PropTypes.func,
    selectable: _reactNative2['default'].PropTypes.bool,
    style: _reactNative2['default'].PropTypes.object,
    wrapperStyle: _reactNative2['default'].PropTypes.object,
    headerStyle: _reactNative2['default'].PropTypes.object,
    bodyStyle: _reactNative2['default'].PropTypes.object,
    footerStyle: _reactNative2['default'].PropTypes.object
  },
  ...
  render: function render() {
    ...
    try {
      for (var _iterator = children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (!_reactNative2['default'].isValidElement(child)) continue;
    ...
    if (fixedHeader) {
      headerTable = _reactNative2['default'].createElement(
        View,
        { className: 'mui-header-table', style: this.prepareStyles(headerStyle) },
    ...
    if (tFoot !== undefined) {
      if (fixedFooter) {
        footerTable = _reactNative2['default'].createElement(
          View,
          { className: 'mui-footer-table', style: this.prepareStyles(footerStyle) },
          _reactNative2['default'].createElement(
            'table',
            { className: className, style: mergedTableStyle },
            tFoot
    ...
    return _reactNative2['default'].createElement(
      View,
      { className: 'mui-table-wrapper', style: this.prepareStyles(styles.tableWrapper, wrapperStyle) },
      headerTable,
      _reactNative2['default'].createElement(
        View,
        { className: 'mui-body-table', style: this.prepareStyles(styles.bodyTable, bodyStyle), ref: 'tableDiv' },
        _reactNative2['default'].createElement(
          'table',
  ...
  _createTableHeader: function _createTableHeader(base) {
    return _reactNative2['default'].cloneElement(base, {
