...
var TableBody = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    deselectOnClickaway: _reactNative2['default'].PropTypes.bool,
    displayRowCheckbox: _reactNative2['default'].PropTypes.bool,
    ...
    preScanRows: _reactNative2['default'].PropTypes.bool,
    selectable: _reactNative2['default'].PropTypes.bool,
    showRowHover: _reactNative2['default'].PropTypes.bool,
    stripedRows: _reactNative2['default'].PropTypes.bool,
  ...
  _createRows: function _createRows() {
    ...
    var numChildren = _reactNative2['default'].Children.count(this.props.children);
    var rowNumber = 0;
    var handlers = {
    ...
    return _reactNative2['default'].Children.map(this.props.children, function (child) {
      if (_reactNative2['default'].isValidElement(child)) {
        var _ret = (function () {
          var props = {
          ...
          _reactNative2['default'].Children.forEach(child.props.children, function (child) {
            children.push(child);
          });

          return {
            v: _reactNative2['default'].cloneElement(child, _extends({}, props, handlers), children)
          };
        })();
  ...
  _createRowCheckboxColumn: function _createRowCheckboxColumn(rowProps) {
    ...
    var checkbox = _reactNative2['default'].createElement(_checkbox2['default'], {
      ref: 'rowSelectCB',
      name: key,
      value: 'selected',
  ...
  _calculatePreselectedRows: function _calculatePreselectedRows(props) {
    ...
    if (props.selectable && props.preScanRows) {
      (function () {
        var index = 0;
        _reactNative2['default'].Children.forEach(props.children, function (child) {
          if (_reactNative2['default'].isValidElement(child)) {
