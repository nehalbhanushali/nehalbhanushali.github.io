...
var TableRow = _reactNative2['default'].createClass({
  ...
  propTypes: {
    displayBorder: _reactNative2['default'].PropTypes.bool,
    hoverable: _reactNative2['default'].PropTypes.bool,
  ...
  _createColumn: function _createColumn(child, columnNumber) {
    ...
    return _reactNative2['default'].cloneElement(child, _extends({
