...
var TableHeader = _reactNative2['default'].createClass({
  ...
  propTypes: {
    adjustForCheckbox: _reactNative2['default'].PropTypes.bool,
    displaySelectAll: _reactNative2['default'].PropTypes.bool,
    enableSelectAll: _reactNative2['default'].PropTypes.bool,
    onSelectAll: _reactNative2['default'].PropTypes.func,
    selectAllSelected: _reactNative2['default'].PropTypes.bool,
  ...
  _createSuperHeaderRow: function _createSuperHeaderRow(child, props) {
    ...
    return _reactNative2['default'].cloneElement(child, props, children);
  },
  ...
  _getCheckboxPlaceholder: function _getCheckboxPlaceholder(props) {
    ...
    return _reactNative2['default'].createElement(_tableHeaderColumn2['default'], { key: key, style: { width: 24 } });
  },
