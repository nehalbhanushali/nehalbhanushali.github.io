...
var RadioButtonGroup = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    valueSelected: _reactNative2['default'].PropTypes.string,
    defaultSelected: _reactNative2['default'].PropTypes.string,
  ...
  componentWillMount: function componentWillMount() {
    ...
    _reactNative2['default'].Children.forEach(this.props.children, function (option) {
  ...
  render: function render() {
    ...
    var options = _reactNative2['default'].Children.map(this.props.children, function (option) {
      ...
      return _reactNative2['default'].createElement(_radioButton2['default'], _extends({}, other, {
