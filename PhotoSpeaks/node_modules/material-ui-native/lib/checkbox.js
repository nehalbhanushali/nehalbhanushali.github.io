...
var Checkbox = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    checkedIcon: _reactNative2['default'].PropTypes.element,
    defaultChecked: _reactNative2['default'].PropTypes.bool,
    iconStyle: _reactNative2['default'].PropTypes.object,
    labelStyle: _reactNative2['default'].PropTypes.object,
    onCheck: _reactNative2['default'].PropTypes.func,
    unCheckedIcon: _reactNative2['default'].PropTypes.element,
