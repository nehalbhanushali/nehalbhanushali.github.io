...
var TextField = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    hintStyle: _reactNative2['default'].PropTypes.object,
    ...
    rowsMax: _reactNative2['default'].PropTypes.number,
    type: _reactNative2['default'].PropTypes.string,
    underlineStyle: _reactNative2['default'].PropTypes.object,
    underlineFocusStyle: _reactNative2['default'].PropTypes.object,
    underlineDisabledStyle: _reactNative2['default'].PropTypes.object,
    style: _reactNative2['default'].PropTypes.object,
    disabled: _reactNative2['default'].PropTypes.bool,
    defaultValue: _reactNative2['default'].PropTypes.string,
  ...
  render: function render() {
    ...
    var errorTextElement = this.state.errorText ? _reactNative2['default'].createElement(
      View,
      { style: this.prepareStyles(styles.error) },
      this.state.errorText
    ) : null;

    var hintTextElement = hintText ? _reactNative2['default'].createElement(
      View,
      { style: this.prepareStyles(styles.hint, hintStyle) },
      hintText
    ) : null;

    var floatingLabelTextElement = floatingLabelText ? _reactNative2['default'].createElement(
      'label',
      {
    ...
    if (this.props.children) {
      ...
      inputElement = _reactNative2['default'].cloneElement(this.props.children, _extends({}, inputProps, this.props.children.props, { style: childInputStyle }));
    } else {
      inputElement = multiLine ? _reactNative2['default'].createElement(_enhancedTextarea2['default'], _extends({}, other, inputProps, {
        style: inputStyle,
        rows: rows,
        rowsMax: rowsMax,
        onHeightChange: this._handleTextAreaHeightChange,
        textareaStyle: this.mergeAndPrefix(styles.textarea) })) : _reactNative2['default'].createElement(TextInput, _extends({}, other, inputProps, {
        style: this.prepareStyles(inputStyle),
        type: type }));
    }

    var underlineElement = undefined; // = <View style={this.prepareStyles(styles.underlineAfter)}/>
    var focusUnderlineElement = undefined; // = <hr style={this.prepareStyles(styles.focusUnderline)} />;
