...
var EnhancedTextarea = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    onHeightChange: _reactNative2['default'].PropTypes.func,
    textareaStyle: _reactNative2['default'].PropTypes.object,
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement('textarea', {
        ref: 'shadow',
      ...
      _reactNative2['default'].createElement('textarea', _extends({}, other, {
        ref: 'input',
        rows: this.props.rows,
