...
var TextInput = _reactNative2['default'].TextInput;

var EnhancedSwitch = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    inputType: _reactNative2['default'].PropTypes.string.isRequired,
    switchElement: _reactNative2['default'].PropTypes.element.isRequired,
    onParentShouldUpdate: _reactNative2['default'].PropTypes.func.isRequired,
    switched: _reactNative2['default'].PropTypes.bool.isRequired,
    rippleStyle: _reactNative2['default'].PropTypes.object,
    rippleColor: _reactNative2['default'].PropTypes.string,
    iconStyle: _reactNative2['default'].PropTypes.object,
    thumbStyle: _reactNative2['default'].PropTypes.object,
    trackStyle: _reactNative2['default'].PropTypes.object,
    labelStyle: _reactNative2['default'].PropTypes.object,
    name: _reactNative2['default'].PropTypes.string,
    value: _reactNative2['default'].PropTypes.string,
    label: _reactNative2['default'].PropTypes.node,
    onSwitch: _reactNative2['default'].PropTypes.func,
    required: _reactNative2['default'].PropTypes.bool,
    disabled: _reactNative2['default'].PropTypes.bool,
    defaultSwitched: _reactNative2['default'].PropTypes.bool,
    labelPosition: _reactNative2['default'].PropTypes.oneOf(['left', 'right']),
    disableFocusRipple: _reactNative2['default'].PropTypes.bool,
    disableTouchRipple: _reactNative2['default'].PropTypes.bool,
  ...
  render: function render() {
    ...
    var labelElement = this.props.label ? _reactNative2['default'].createElement(
      'label',
    ...
    var inputElement = _reactNative2['default'].createElement(TextInput, _extends({}, other, inputProps));

    var touchRipple = _reactNative2['default'].createElement(_ripplesTouchRipple2['default'], {
      ref: 'touchRipple',
      key: 'touchRipple',
      style: rippleStyle,
      color: rippleColor,
    ...
    var focusRipple = _reactNative2['default'].createElement(_ripplesFocusRipple2['default'], {
      key: 'focusRipple',
    ...
    var switchElement = !this.props.thumbStyle ? _reactNative2['default'].createElement(
      View,
      { style: wrapStyles },
      ...
      View,
      { style: wrapStyles },
      _reactNative2['default'].createElement(View, { style: this.prepareStyles(this.props.trackStyle) }),
      _reactNative2['default'].createElement(
        _paper2['default'],
    ...
    var elementsInOrder = labelPositionExist && this.props.labelPosition.toUpperCase() === 'RIGHT' ? _reactNative2['default'].createElement(
      _clearfix2['default'],
