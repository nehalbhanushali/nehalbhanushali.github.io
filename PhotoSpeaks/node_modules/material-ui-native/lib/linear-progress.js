...
var LinearProgress = _reactNative2['default'].createClass({
  displayName: 'LinearProgress',

  mixins: [_mixinsStylePropable2['default']],

  propTypes: {
    mode: _reactNative2['default'].PropTypes.oneOf(['determinate', 'indeterminate']),
    value: _reactNative2['default'].PropTypes.number,
  ...
  getStyles: function getStyles() {
    ...
    } else ////transition: Transitions.create('all', '840ms', null, 'cubic-bezier(0.165, 0.840, 0.440, 1.000)'),
      {
        styles.bar.backgroundColor = this.props.color || this.getTheme().primary1Color;
        styles.bar.transition = _stylesTransitions2['default'].create('width', '.3s', null, 'linear');
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(
        ...
        _reactNative2['default'].createElement(View, { ref: 'bar1', style: this.prepareStyles(styles.barFragment1) }),
        _reactNative2['default'].createElement(View, { ref: 'bar2', style: this.prepareStyles(styles.barFragment2) })
      )
    );
  }
});
