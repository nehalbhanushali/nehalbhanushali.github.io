...
var IconButton = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    tooltip: _reactNative2['default'].PropTypes.node,
    tooltipStyles: _reactNative2['default'].PropTypes.object,
    tooltipPosition: _utilsPropTypes2['default'].cornersAndCenter,
    touch: _reactNative2['default'].PropTypes.bool,
  ...
  render: function render() {
    ...
    var tooltipElement = tooltip ? _reactNative2['default'].createElement(_tooltip2['default'], {
      ref: 'tooltip',
      label: tooltip,
    ...
    if (iconClassName) {
      ...
      fonticon = _reactNative2['default'].createElement(
        _fontIcon2['default'],
        {
