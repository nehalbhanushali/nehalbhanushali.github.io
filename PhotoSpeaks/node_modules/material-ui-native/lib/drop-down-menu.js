...
var DropDownMenu = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    displayMember: _reactNative2['default'].PropTypes.string,
    valueMember: _reactNative2['default'].PropTypes.string,
    ...
    openImmediately: _reactNative2['default'].PropTypes.bool,
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(
        ...
        _reactNative2['default'].createElement(_paper2['default'], { style: this.mergeStyles(styles.controlBg), zDepth: 0 }),
        _reactNative2['default'].createElement(
          View,
          { style: this.prepareStyles(styles.label, this.state.open && styles.labelWhenOpen, labelStyle) },
          displayValue
        ),
        _reactNative2['default'].createElement(View, { style: this.prepareStyles(styles.underline, underlineStyle) })
      ),
      _reactNative2['default'].createElement(_menuMenu2['default'], {
        ref: 'menuItems',
        autoWidth: autoWidth,
      ...
      this.state.open && _reactNative2['default'].createElement(View, { style: this.prepareStyles(styles.overlay), onTouchTap: this._handleOverlayTouchTap })
    );
  },
