...
var DayButton = _reactNative2['default'].createClass({
  ...
  propTypes: {
    date: _reactNative2['default'].PropTypes.object,
  ...
  render: function render() {
    ...
    return this.props.date ? _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(View, { style: this.prepareStyles(styles.buttonState) }),
      _reactNative2['default'].createElement(
        View,
        { style: this.prepareStyles(styles.label) },
        this.props.date.getDate()
      )
    ) : _reactNative2['default'].createElement(View, { style: this.prepareStyles(styles.root) });
  },
