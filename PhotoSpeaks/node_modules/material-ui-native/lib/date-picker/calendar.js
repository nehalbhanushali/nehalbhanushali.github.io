...
var Calendar = _reactNative2['default'].createClass({
  ...
  propTypes: {
    DateTimeFormat: _reactNative2['default'].PropTypes.func.isRequired,
    locale: _reactNative2['default'].PropTypes.string.isRequired,
    disableYearSelection: _reactNative2['default'].PropTypes.bool,
    initialDate: _reactNative2['default'].PropTypes.object,
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(_dateDisplay2['default'], {
        ...
        weekCount: weekCount }),
      this.state.displayMonthDay && _reactNative2['default'].createElement(
        View,
        { style: this.prepareStyles(styles.calendarContainer) },
        _reactNative2['default'].createElement(_calendarToolbar2['default'], {
          DateTimeFormat: DateTimeFormat,
          locale: locale,
        ...
        _reactNative2['default'].createElement(
          ...
          _reactNative2['default'].createElement(_calendarMonth2['default'], {
  ...
  _yearSelector: function _yearSelector() {
    ...
    return _reactNative2['default'].createElement(_calendarYear2['default'], {
      key: 'years',
      displayDate: this.state.displayDate,
