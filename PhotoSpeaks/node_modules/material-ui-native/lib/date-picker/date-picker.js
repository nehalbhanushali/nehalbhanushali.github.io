...
var DatePicker = _reactNative2['default'].createClass({
  ...
  propTypes: {
    container: _reactNative2['default'].PropTypes.oneOf(['dialog', 'inline']),
    DateTimeFormat: _reactNative2['default'].PropTypes.func,
    locale: _reactNative2['default'].PropTypes.string,
    wordings: _reactNative2['default'].PropTypes.object,
    autoOk: _reactNative2['default'].PropTypes.bool,
    defaultDate: _reactNative2['default'].PropTypes.object,
    formatDate: _reactNative2['default'].PropTypes.func,
    hideToolbarYearChange: _reactNative2['default'].PropTypes.bool,
    maxDate: _reactNative2['default'].PropTypes.object,
    minDate: _reactNative2['default'].PropTypes.object,
    mode: _reactNative2['default'].PropTypes.oneOf(['portrait', 'landscape']),
    ...
    onShow: _reactNative2['default'].PropTypes.func,
    onTouchTap: _reactNative2['default'].PropTypes.func,
    shouldDisableDate: _reactNative2['default'].PropTypes.func,
    showYearSelector: _reactNative2['default'].PropTypes.bool,
    style: _reactNative2['default'].PropTypes.object,
    textFieldStyle: _reactNative2['default'].PropTypes.object,
    value: _reactNative2['default'].PropTypes.object
  },
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(_datePickerDialog2['default'], {
        container: container,
        ref: 'dialogWindow',
