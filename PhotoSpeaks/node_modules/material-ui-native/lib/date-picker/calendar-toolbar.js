...
var CalendarToolbar = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    nextMonth: _reactNative2['default'].PropTypes.bool,
    onMonthChange: _reactNative2['default'].PropTypes.func,
    prevMonth: _reactNative2['default'].PropTypes.bool
  },
  ...
  render: function render() {
    ...
    var nextButtonIcon = undefined; //= this.state.muiTheme.isRtl ? <NavigationChevronRight /> : <NavigationChevronLeft />;
    var prevButtonIcon = undefined; //= this.state.muiTheme.isRtl ? <NavigationChevronLeft /> : <NavigationChevronRight />;
