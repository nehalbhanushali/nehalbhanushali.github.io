...
var DropDownIcon = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    closeOnMenuItemTouchTap: _reactNative2['default'].PropTypes.bool,
    iconStyle: _reactNative2['default'].PropTypes.object,
    iconClassName: _reactNative2['default'].PropTypes.string,
    iconLigature: _reactNative2['default'].PropTypes.string,
