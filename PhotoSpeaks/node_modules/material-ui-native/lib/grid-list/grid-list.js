...
var GridList = _reactNative2['default'].createClass({
  ...
  propTypes: {
    cols: _reactNative2['default'].PropTypes.number,
    padding: _reactNative2['default'].PropTypes.number,
    cellHeight: _reactNative2['default'].PropTypes.number,
  ...
  render: function render() {
    ...
    var wrappedChildren = _reactNative2['default'].Children.map(children, function (currentChild) {
      //const childCols = currentChild.props.cols || 1;
      //const childRows = currentChild.props.rows || 1;
      var itemStyle = ''; /*this.mergeStyles(styles.item, {
