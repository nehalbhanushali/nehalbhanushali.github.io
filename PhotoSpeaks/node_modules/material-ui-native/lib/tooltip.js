...
var Tooltip = _reactNative2['default'].createClass({
  displayName: 'Tooltip',
  ...
  propTypes: {
    ...
    label: _reactNative2['default'].PropTypes.node.isRequired,
    show: _reactNative2['default'].PropTypes.bool,
    touch: _reactNative2['default'].PropTypes.bool,
    verticalPosition: _reactNative2['default'].PropTypes.oneOf(['top', 'bottom']),
    horizontalPosition: _reactNative2['default'].PropTypes.oneOf(['left', 'right', 'center']),
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(View, {
        ref: 'ripple',
