...
var List = _reactNative2['default'].createClass({
  displayName: 'List',
  ...
  propTypes: {
    insetSubheader: _reactNative2['default'].PropTypes.bool,
    style: _reactNative2['default'].PropTypes.object,
    subheader: _reactNative2['default'].PropTypes.node,
    subheaderStyle: _reactNative2['default'].PropTypes.object,
  ...
  render: function render() {
    ...
    if (subheader) {
      ...
      subheaderElement = _reactNative2['default'].createElement(
        View,
