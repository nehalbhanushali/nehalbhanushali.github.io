...
var TouchRipple = _reactNative2['default'].createClass({
  ...
  start: function start(e, isRippleTouchGenerated) {
    ...
    ripples = _utilsImmutabilityHelper2['default'].push(ripples, _reactNative2['default'].createElement(_circleRipple2['default'], {
