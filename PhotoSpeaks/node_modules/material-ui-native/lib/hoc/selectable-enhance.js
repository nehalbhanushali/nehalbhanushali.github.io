...
var SelectableContainerEnhance = function SelectableContainerEnhance(Component) {
  var composed = _reactNative2['default'].createClass({
    ...
    propTypes: {
      valueLink: _reactNative2['default'].PropTypes.shape({
        value: _reactNative2['default'].PropTypes.number,
        requestChange: _reactNative2['default'].PropTypes.func
      }).isRequired,
      selectedItemStyle: _reactNative2['default'].PropTypes.object
    },
    ...
    render: function render() {
      ...
      listItems = _reactNative2['default'].Children.map(children, function (child) {
