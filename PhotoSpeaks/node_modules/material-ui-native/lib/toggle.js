...
var Toggle = _reactNative2['default'].createClass({
  displayName: 'Toggle',
  ...
  propTypes: {
    elementStyle: _reactNative2['default'].PropTypes.object,
    labelStyle: _reactNative2['default'].PropTypes.object,
    onToggle: _reactNative2['default'].PropTypes.func,
    toggled: _reactNative2['default'].PropTypes.bool,
    defaultToggled: _reactNative2['default'].PropTypes.bool,
  ...
  render: function render() {
    ...
    var toggleElement = _reactNative2['default'].createElement(
      View,
      { style: this.prepareStyles(toggleElementStyles) },
      _reactNative2['default'].createElement(View, { style: this.prepareStyles(trackStyles) }),
      _reactNative2['default'].createElement(_paper2['default'], { style: thumbStyles, circle: true, zDepth: 1 })
    );
    ...
    return _reactNative2['default'].createElement(_enhancedSwitch2['default'], _extends({}, other, enhancedSwitchProps));
  },
