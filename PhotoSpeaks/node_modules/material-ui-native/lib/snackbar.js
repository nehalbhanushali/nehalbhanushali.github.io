...
var Snackbar = _reactNative2['default'].createClass({
  ...
  propTypes: {
    message: _reactNative2['default'].PropTypes.node.isRequired,
    action: _reactNative2['default'].PropTypes.string,
    autoHideDuration: _reactNative2['default'].PropTypes.number,
    onActionTouchTap: _reactNative2['default'].PropTypes.func,
    onShow: _reactNative2['default'].PropTypes.func,
    onDismiss: _reactNative2['default'].PropTypes.func,
    openOnMount: _reactNative2['default'].PropTypes.bool,
  ...
  render: function render() {
    ...
    if (action) {
      actionButton = _reactNative2['default'].createElement(_flatButton2['default'], {
        style: styles.action,
        label: action,
