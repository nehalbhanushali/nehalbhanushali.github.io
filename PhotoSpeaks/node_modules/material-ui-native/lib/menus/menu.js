...
var Menu = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    initiallyKeyboardFocused: _reactNative2['default'].PropTypes.bool,
    listStyle: _reactNative2['default'].PropTypes.object,
    maxHeight: _reactNative2['default'].PropTypes.number,
    multiple: _reactNative2['default'].PropTypes.bool,
    onEscKeyDown: _reactNative2['default'].PropTypes.func,
    onItemTouchTap: _reactNative2['default'].PropTypes.func,
    ...
    selectedMenuItemStyle: _reactNative2['default'].PropTypes.object,
  ...
  render: function render() {
    ...
    var newChildren = _reactNative2['default'].Children.map(children, function (child) {
      ...
      var clonedChild = childIsADivider ? child : childIsDisabled ? _reactNative2['default'].cloneElement(child, { desktop: desktop }) : _this2._cloneMenuItem(child, menuItemIndex, styles);

      if (!childIsADivider && !childIsDisabled) menuItemIndex++;

      return animated ? _reactNative2['default'].createElement(
        View,
  ...
  _getCascadeChildrenCount: function _getCascadeChildrenCount() {
    ...
    if (!maxHeight) return _reactNative2['default'].Children.count(children);

    //Count all the children that will fit inside the
    //max menu height
    _reactNative2['default'].Children.forEach(children, function (child) {
  ...
  _getMenuItemCount: function _getMenuItemCount() {
    var menuItemCount = 0;
    _reactNative2['default'].Children.forEach(this.props.children, function (child) {
      var childIsADivider = child.type && child.type.displayName === 'MenuDivider';
      var childIsDisabled = child.props.disabled;
