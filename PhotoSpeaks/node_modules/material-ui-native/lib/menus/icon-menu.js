...
var IconMenu = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    closeOnItemTouchTap: _reactNative2['default'].PropTypes.bool,
    iconButtonElement: _reactNative2['default'].PropTypes.element.isRequired,
  ...
  render: function render() {
    ...
    var iconButton = _reactNative2['default'].cloneElement(iconButtonElement, {
    ...
    var menu = _reactNative2['default'].createElement(
      _menusMenu2['default'],
      _extends({}, other, {
        animateOpen: true,
