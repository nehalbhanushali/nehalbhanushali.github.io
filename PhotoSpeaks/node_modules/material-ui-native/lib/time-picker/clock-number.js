...
var ClockNumber = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    type: _reactNative2['default'].PropTypes.oneOf(['hour', 'minute']),
    onSelected: _reactNative2['default'].PropTypes.func,
    isSelected: _reactNative2['default'].PropTypes.bool
  },
