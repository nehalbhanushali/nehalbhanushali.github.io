...
var ClockButton = _reactNative2['default'].createClass({
  ...
  propTypes: {
    position: _reactNative2['default'].PropTypes.oneOf(['left', 'right'])
  },
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(View, { style: this.prepareStyles(styles.select) }),
