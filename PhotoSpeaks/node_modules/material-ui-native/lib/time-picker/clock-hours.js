...
var ClockHours = _reactNative2['default'].createClass({
  ...
  propTypes: {
    initialHours: _reactNative2['default'].PropTypes.number,
    onChange: _reactNative2['default'].PropTypes.func,
    format: _reactNative2['default'].PropTypes.oneOf(['ampm', '24hr'])
  },
  ...
  _getHourNumbers: function _getHourNumbers() {
    ...
    return hours.map(function (hour) {
      ...
      return _reactNative2['default'].createElement(_clockNumber2['default'], { key: hour, style: style, isSelected: isSelected, type: 'hour',
        value: hour });
    });
  },
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(_clockPointer2['default'], { hasSelected: true, value: hours, type: 'hour' }),
      numbers,
      _reactNative2['default'].createElement(View, { ref: 'mask', style: this.prepareStyles(styles.hitMask), onTouchMove: this.handleTouchMove,
