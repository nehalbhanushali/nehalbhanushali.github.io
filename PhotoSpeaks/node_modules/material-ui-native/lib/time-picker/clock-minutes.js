...
var ClockMinutes = _reactNative2['default'].createClass({
  ...
  propTypes: {
    initialMinutes: _reactNative2['default'].PropTypes.number,
  ...
  _getMinuteNumbers: function _getMinuteNumbers() {
    ...
    var numbers = minutes.map(function (minute) {
      ...
      return _reactNative2['default'].createElement(_clockNumber2['default'], { key: minute, isSelected: isSelected, type: 'minute', value: minute });
    });
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(_clockPointer2['default'], { value: minutes.selected, type: 'minute' }),
      minutes.numbers,
      _reactNative2['default'].createElement(View, { ref: 'mask', style: this.prepareStyles(styles.hitMask), hasSelected: minutes.hasSelected,
