...
var Popover = _reactNative2['default'].createClass({
  displayName: 'Popover',

  mixins: [_mixinsContextPure2['default'], _mixinsStylePropable2['default'], _mixinsWindowListenable2['default']],

  propTypes: {
    anchorEl: _reactNative2['default'].PropTypes.object,
    anchorOrigin: _utilsPropTypes2['default'].origin,
    animated: _reactNative2['default'].PropTypes.bool,
    autoCloseWhenOffScreen: _reactNative2['default'].PropTypes.bool,
    canAutoPosition: _reactNative2['default'].PropTypes.bool,
    children: _reactNative2['default'].PropTypes.object,
  ...
  render: function render() {
    return _reactNative2['default'].createElement(_renderToLayer2['default'], _extends({
      ref: 'layer'
    }, this.props, {
