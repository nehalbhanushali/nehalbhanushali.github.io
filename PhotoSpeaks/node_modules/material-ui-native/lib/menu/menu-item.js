...
var MenuItem = _reactNative2['default'].createClass({
  ...
  propTypes: {
    ...
    iconClassName: _reactNative2['default'].PropTypes.string,
    iconRightClassName: _reactNative2['default'].PropTypes.string,
    iconStyle: _reactNative2['default'].PropTypes.object,
    iconRightStyle: _reactNative2['default'].PropTypes.object,
    attribute: _reactNative2['default'].PropTypes.string,
    number: _reactNative2['default'].PropTypes.string,
    data: _reactNative2['default'].PropTypes.string,
    toggle: _reactNative2['default'].PropTypes.bool,
    ...
    icon: _reactNative2['default'].PropTypes.node
  },
  ...
  render: function render() {
    ...
    if (this.props.iconClassName) icon = _reactNative2['default'].createElement(_fontIcon2['default'], { style: this.mergeStyles(styles.icon, this.props.iconStyle, this.props.selected && styles.rootWhenSelected), className: this.props.iconClassName });
    if (this.props.iconRightClassName) iconRight = _reactNative2['default'].createElement(_fontIcon2['default'], { style: this.mergeStyles(styles.iconRight, this.props.iconRightStyle), className: this.props.iconRightClassName });
    if (this.props.data) data = _reactNative2['default'].createElement(
      View,
      { style: this.prepareStyles(styles.data) },
      this.props.data
    );
    if (this.props.number !== undefined) number = _reactNative2['default'].createElement(
      View,
      { style: this.prepareStyles(styles.number) },
      this.props.number
    );
    if (this.props.attribute !== undefined) attribute = _reactNative2['default'].createElement(
      View,
    ...
    if (this.props.toggle) {
      ...
      toggleElement = _reactNative2['default'].createElement(_toggle2['default'], _extends({}, other, { onToggle: this._handleToggle, style: styles.toggle }));
    }
