...
var _utilsKeyLine = require('../utils/key-line');

var _utilsKeyLine2 = _interopRequireDefault(_utilsKeyLine);
...
***********************/
var NestedMenuItem = _reactNative2['default'].createClass({
  displayName: 'NestedMenuItem',

  mixins: [_mixinsClickAwayable2['default'], _mixinsStylePropable2['default']],
  ...
  propTypes: {
    ...
    zDepth: _reactNative2['default'].PropTypes.number,
    disabled: _reactNative2['default'].PropTypes.bool,
    active: _reactNative2['default'].PropTypes.bool,
    onItemTap: _reactNative2['default'].PropTypes.func,
    menuItemStyle: _reactNative2['default'].PropTypes.object,
    style: _reactNative2['default'].PropTypes.object,
    onMouseOver: _reactNative2['default'].PropTypes.func,
    onMouseOut: _reactNative2['default'].PropTypes.func
  },
  ...
  render: function render() {
    ...
    return _reactNative2['default'].createElement(
      ...
      _reactNative2['default'].createElement(Menu, _extends({}, other, {
        ref: 'nestedMenu',
...
* Menu Component
****************/
var Menu = _reactNative2['default'].createClass({
  displayName: 'Menu',
  ...
  propTypes: {
    ...
    onItemTap: _reactNative2['default'].PropTypes.func,
    onToggle: _reactNative2['default'].PropTypes.func,
    onRequestClose: _reactNative2['default'].PropTypes.func,
    menuItems: _reactNative2['default'].PropTypes.array.isRequired,
    selectedIndex: _reactNative2['default'].PropTypes.number,
    style: _reactNative2['default'].PropTypes.object,
    hideable: _reactNative2['default'].PropTypes.bool,
    visible: _reactNative2['default'].PropTypes.bool,
    zDepth: _reactNative2['default'].PropTypes.number,
    menuItemStyle: _reactNative2['default'].PropTypes.object,
    menuItemStyleSubheader: _reactNative2['default'].PropTypes.object,
    menuItemStyleLink: _reactNative2['default'].PropTypes.object,
    menuItemClassName: _reactNative2['default'].PropTypes.string,
    menuItemClassNameSubheader: _reactNative2['default'].PropTypes.string,
    menuItemClassNameLink: _reactNative2['default'].PropTypes.string,
    onItemToggle: _reactNative2['default'].PropTypes.func
  },
    ...
    for (var i = 0; i < this.props.menuItems.length; i++) {
      ...
      switch (menuItem.type) {
        ...
        case _menuItem3['default'].Types.LINK:
          itemComponent = _reactNative2['default'].createElement(_linkMenuItem2['default'], {
            key: i,
            index: i,
        ...
        case _menuItem3['default'].Types.SUBHEADER:
          itemComponent = _reactNative2['default'].createElement(_subheaderMenuItem2['default'], {
            key: i,
            index: i,
        ...
        case _menuItem3['default'].Types.NESTED:
          ...
          itemComponent = _reactNative2['default'].createElement(NestedMenuItem, _extends({}, other, {
            ref: i,
            key: i,
            index: i,
            nested: true,
        ...
        default:
          itemComponent = _reactNative2['default'].createElement(
            _menuItem3['default'],
            _extends({}, other, {
  ...
  _setKeyWidth: function _setKeyWidth(el) {
    ...
    if (this.props.autoWidth) {
      el.style.width = 'auto';
      menuWidth = _utilsKeyLine2['default'].getIncrementalDim(el.offsetWidth) + 'px';
    }
  ...
  _expandHideableMenu: function _expandHideableMenu() {
    ...
    if (!el.style.transition) {
      el.style.transition = _stylesTransitions2['default'].easeOut();
    }
    ...
    this._nextAnimationFrame(function () {
      ...
      _utilsCssEvent2['default'].onTransitionEnd(el, function () {
  ...
  _collapseHideableMenu: function _collapseHideableMenu() {
    ...
    this._nextAnimationFrame(function () {
      ...
      if (originalOpacity === '') end();else _utilsCssEvent2['default'].onTransitionEnd(el, end);
    });
  },
